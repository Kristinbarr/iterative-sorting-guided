...
# O(1)
##########
# How many operations do we need to do in order complete a function?
# no matter how big or small the input, it will take the same amount of time
# this function returns a pointer to place in memory
...
# O(n)
##########
# for n items, we need to do n things
...
# O(n)
##########
# fisher yates shuffle (we'll do in graphs)
